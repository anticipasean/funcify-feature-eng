...
object GraphQLSourceNamingConventions {
    ...
    private val FIELD_DEFINITION_PATH_NAMING_CONVENTION:
        ...
        NamingConventionFactory.getDefaultFactory()
            ...
            .followConvention {
                ...
                forEverySegment { forAnyCharacter { makeAllLowercase() } }
            }
            .joinSegmentsWith('_')
            .namedAndIdentifiedBy("GraphQLFieldDefinitionPathName", PATH_NAMING_CONVENTION)
    }

    private val FIELD_DEFINITION_FIELD_NAMING_CONVENTION:
        NamingConvention<GraphQLFieldDefinition> by lazy {
        NamingConventionFactory.getDefaultFactory()
            .createConventionFor<GraphQLFieldDefinition>()
            .whenInputProvided {
            ...
            .namedAndIdentifiedBy("GraphQLFieldDefinitionFieldName", FIELD_NAMING_CONVENTION)
    }

    fun getPathNamingConventionForGraphQLFieldDefinitions():
