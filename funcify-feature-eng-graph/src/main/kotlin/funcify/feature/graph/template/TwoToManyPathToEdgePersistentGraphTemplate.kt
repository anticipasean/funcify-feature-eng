...
internal interface TwoToManyPathToEdgePersistentGraphTemplate :
    ...
    override fun <P, V, E> fromVertexAndEdgeStreams(
        ...
        return PersistentGraphContainerFactory.TwoToManyPathToEdgeGraph<P, V, E>(
            verticesByPath = verticesByPath,
    ...
    override fun <P, V, E> put(
        path: P,
        vertex: V,
        container: PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, V, E>
    ): PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, V, E> {
    ...
    override fun <P, V, E, R> mapVertices(
        function: (V) -> R,
        container: PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, V, E>
    ): PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, R, E> {
        val updatedVertices =
            container
                .narrowed()
                .verticesByPath
    ...
    override fun <P, V, E, R> mapEdges(
        function: (E) -> R,
        container: PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, V, E>
    ): PersistentGraphContainer<TwoToManyPathToEdgeGraphWT, P, V, R> {
        val updatedEdges =
            container
                .narrowed()
                .edgesSetByPathPair
