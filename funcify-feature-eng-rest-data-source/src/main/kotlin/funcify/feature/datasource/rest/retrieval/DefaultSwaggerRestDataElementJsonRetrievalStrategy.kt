 ...
 * @created 2022-08-15
 */
internal class DefaultSwaggerRestDataElementJsonRetrievalStrategy
  /*  (
      ...
      private val postProcessingStrategy: SwaggerRestApiJsonResponsePostProcessingStrategy
                                                                   ) : DataElementRepresentativeJsonRetrievalStrategy<RestApiSourceIndex> {

      companion object {
          private val logger: Logger = loggerFor<DefaultSwaggerRestDataElementJsonRetrievalStrategy>()
                          ...
                          Try.fromOption(
                              ...
                              RestApiDataSourceException(
                                  ...
                                  """all source_vertices must have a representative source_index
                                     ...
                                     |${DefaultSwaggerRestDataElementJsonRetrievalStrategy::class.qualifiedName}
