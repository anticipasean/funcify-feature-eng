...
interface SchematicPath {
        ...
        return when {
            ...
            this.pathSegments.size + 1 == other.pathSegments.size -> {
                pathSegments.asSequence()
                        .zip(other.pathSegments.asSequence()) { a: String, b: String ->
                            a == b
                        }
                        .all { matched -> matched }
            }
    ...
    fun isChildTo(other: SchematicPath): Boolean {
        return when {
            ...
            this.pathSegments.size - 1 == other.pathSegments.size -> {
                other.pathSegments.asSequence()
                        .zip(this.pathSegments.asSequence()) { a: String, b: String ->
                            a == b
                        }
                        .all { matched -> matched }
            }
        ...
        return when {
            ...
            this.pathSegments.size == other.pathSegments.size -> {
                ...
                pathSegments.asSequence()
                        ...
                        .zip(other.pathSegments.asSequence()
                                     .take(parentPathSegmentsSize)) { a: String, b: String ->
                            a == b
                        }
                        .all { matched -> matched }
            }
