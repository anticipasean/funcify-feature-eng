 ...
 * @created 4/2/22
 */
internal class TwoToOneEdgeDepthFirstSearchSpliterator<P, V, E>(private val inputPath: P,
    ...
    override fun tryAdvance(action: Consumer<in Tuple5<V, P, E, P, V>>?): Boolean {
        ...
        val fullPathConnectionsForChildPath: Option<Tuple5<V, P, E, P, V>> = getFullPathConnectionForChildPath(childPath)
