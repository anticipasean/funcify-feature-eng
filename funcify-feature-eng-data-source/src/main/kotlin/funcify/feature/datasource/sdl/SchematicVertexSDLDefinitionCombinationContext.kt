...
import funcify.feature.datasource.sdl.SchematicVertexSDLDefinitionCombinationContext.Builder
...
/**
 * Immutable context providing what GraphQL SDL definitions have been defined organized by type for
 * a given vertex in the [MetamodelGraph], its parent context (if it has a parent vertex), and its
 * composite source index value. Callers may "update" this context through the [update] function
 * parameter (effectively creating a new context instance with whatever new definitions that have
 * been added or old definitions that have been removed)
 *
 ...
 * @created 2022-06-24
 */
sealed interface SchematicVertexSDLDefinitionCombinationContext<V : SchematicVertex> {
    ...
    val directiveDefinitionBySchematicPath: ImmutableMap<SchematicPath, DirectiveDefinition>
    ...
    val parentContext: Option<SchematicVertexSDLDefinitionCombinationContext<*>>
    ...
    ): SchematicVertexSDLDefinitionCombinationContext<SV>
    ...
    interface Builder<V : SchematicVertex> {
        ...
        fun build(): SchematicVertexSDLDefinitionCombinationContext<V>
    }

    interface SourceRootVertexSDLDefinitionCombinationContext :
    ...
    interface SourceJunctionVertexSDLDefinitionCombinationContext :
        SchematicVertexSDLDefinitionCombinationContext<SourceJunctionVertex> {
    ...
    interface SourceLeafVertexSDLDefinitionCombinationContext :
        SchematicVertexSDLDefinitionCombinationContext<SourceLeafVertex> {
    ...
    interface ParameterJunctionVertexSDLDefinitionCombinationContext :
        SchematicVertexSDLDefinitionCombinationContext<ParameterJunctionVertex> {
    ...
    interface ParameterLeafVertexSDLDefinitionCombinationContext :
        SchematicVertexSDLDefinitionCombinationContext<ParameterLeafVertex> {
